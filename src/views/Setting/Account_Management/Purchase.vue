            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">                
                        ...
                        <span class="text-white font-bold text-2xl">進貨查詢</span> 
                    </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <div class="flex mb-6 flex-wrap">
                            <div class="mr-14">
                                <label for="PurchaseID">進貨訂單編號</label>
                                <input id="PurchaseID" class="search" type="text">
                            </div>
                            <div class="mr-14">
                                <label for="PurchaseISBN">ISBN</label>
                                <input id="PurchaseISBN" class="search" type="text">
                            </div>
                            <div class="mr-14">
                                <label for="PurchaseDate">進貨日期區間</label>
